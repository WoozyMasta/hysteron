...
//
//	mockgen -destination=../mock/store/store.go -source=store.go
//
...
import (
	...
	cluster "github.com/woozymasta/hysteron/internal/cluster"
	store "github.com/woozymasta/hysteron/internal/store"
