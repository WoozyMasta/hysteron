...
* Annotate the master keeperUID (previously called keeper id). You can retrieve this using `stolon cluster status`.
...
```
stolon cluster initialize '{ "initMode": "existing", "existingConfig": { "keeperUID": "keeper01" } }'
```
