...
| replicationTLSMode               | TLS policy (`sslmode`) used for internal replication connections between managed instances. Allowed values: `prefer`, `require`, `verify-ca`, `verify-full`.                                                                                                                                                                                                                                                                                                                     | no                        | string            | prefer                                                                                                                              |
...
| checkpointBeforePgrewind         | force `CHECKPOINT` on the current primary before `pg_rewind`. Improves rewind reliability after promotion at the cost of extra I/O and latency on the source primary.                                                                                                                                                                                                                                                                                                      | no                        | bool              | false                                                                                                                               |
...
| pgIdent                          | a list containing additional pg_ident.conf entries. They are written as-is to generated `pg_ident.conf` and reloaded with PostgreSQL config reload.                                                                                                                                                                                                                                                                                                                               | no                        | []string          | null                                                                                                                                |
